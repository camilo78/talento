        ...
        <tbody>
            @foreach ($departments as $department)
                <tr>
                    ...
                    <td class="pt-1 pb-1 align-middle {{ $department->users->where('boss', '1')->last()->fullname  ?? 'text-warning small' }}">{{$department->users->where('boss', '1')->last()->fullname  ?? 'Sin Jefe Asignado' }}
