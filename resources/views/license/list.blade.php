...
<table class="table table table-striped table-bordered bg-white shadow mt-1" id="license">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="pt-1 pb-1 align-middle">{{ $license->user_id }}</td>
            <td class="pt-1 pb-1 align-middle">
                {{$license->reason}}
            </td>
            <td class="pt-1 pb-1 align-middle">{{ $license->department_id}}</td>
            <td class="pt-1 pb-1 align-middle">{{ $license->beginning}}</td>
            <td class="pt-1 pb-1 align-middle">{{ $license->end}}</td>
            <td class="pt-1 pb-1 align-middle">{{ $license->days}}</td>
            <td class="pt-1 pb-1 align-middle">{{ $license->boss}}</td>
            <td class="pt-1 pb-1 align-middle">{{ $license->immediate_boss}}</td>
            <td class="pt-1 pb-1 align-middle">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('license.edit', $license->id) }}" class="btn btn-sm btn-primary mr-2"><i class="fa-solid fa-pen-to-square"></i></a>
                    <a href="{{ route('license.destroy', $license->id) }}" class="btn btn-sm btn-danger" data-confirm-delete="true"><i class="fa-solid fa-trash"></i></a>
                </div>
            </td>
        </tr>
        @endforeach
