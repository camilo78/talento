...
@section('main-content')
    ...
    <h1 class="h3 text-gray-800">Especialidades</h1>

    <table class="table table table-striped table-bordered bg-white shadow mt-1" width="100%" id="specialties">
        <thead>
            <tr>
        ...
        <tbody>
            @foreach ($specialties as $specialty)
                <tr>
                    ...
                    <td class="pt-1 pb-1 align-middle">{{ $specialty->name }}</td>
                    <td class="pt-1 pb-1 align-middle">{{ $specialty->profession->profession }}</td>
                    <td class="pt-1 pb-1 align-middle">
                        <div class="d-flex justify-content-center">
                            <a href="{{ route('specialties.edit', $specialty->id) }}" class="btn btn-sm btn-primary mr-2"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a href="{{ route('specialties.destroy', $specialty->id) }}" class="btn btn-sm btn-danger" data-confirm-delete="true"><i class="fa-solid fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
            @endforeach
    ...
    new DataTable('#specialties', {
        ...
        , buttons: {
            buttons: [{
                    ...
                    , text: '<i class="fa-solid fa-graduation-cap"></i> Nueva Especialidad'
                    , action: function(e, dt, button, config) {
                        window.location = '{{ route('specialties.create') }}';
                    }
