...
class DepartmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Subdirección de la Información - Oficinas
        Department::create([
        ...
        // Subdirección de Gestión de Recursos - Departamentos
        Department::create([
        ...
        // Logística y Suministros - Subdepartamentos
        Department::create([
            'name' => 'Almacén', //12
            'user_id' => '12',
            'parent_id' => 9,
        ...
        // Gestión Financiera - Subdepartamentos
        Department::create([
        ...
        // Servicios Generales - Subdepartamentos
        Department::create([
            'name' => 'Vigilancia', //16
            'user_id' => '16',
            'parent_id' => 11,
        ...
        // Subdirección Asistencial - Departamentos
        Department::create([
            'name' => 'Enfermería', //23
            'user_id' => '23',
            'parent_id' => 3,
        ...
        // Gestión de Pacientes - Subdepartamentos
        Department::create([
        ...
        // Admisión y Archivo - Subdepartamentos
        Department::create([
            'name' => 'Archivo', //38
            'user_id' => '38',
            'parent_id' => 37,
        ...
        // Gestión Clínica - Subdepartamentos
        Department::create([
            'name' => 'Laboratorio', //41
            'user_id' => '41',
            'parent_id' => 40,
