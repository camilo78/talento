...
class ReasonsTableSeeder extends Seeder
{
    public function run()
    {
        DB::table('reasons')->insert([
            ...
            [
                'reason' => 'Graves asuntos de familia diferentes a los indicados en las licencias Remunerados',
